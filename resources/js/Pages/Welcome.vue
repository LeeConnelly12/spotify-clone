...
<template>
  <Head title="Welcome" />
  <div
    class="mt-4 bg-gray-50 px-4 text-black/50 dark:bg-black dark:text-white/50"
  >
    <img
      id="background"
        ...
        >
          ...
          <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
            <Link
              ...
              class="rounded-md py-2 px-3 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
            >
              Dashboard
            </Link>
